...
// Import LiveKit client and hooks
import { Room as LiveKitRoomClass, Track } from "livekit-client";
...
export default function Room({ params }: RoomProps) {
  ...
  // Initialize room instance - no longer needed as we create it directly
  ...
  // Auto-connect when we have connection details and room is ready
  useEffect(() => {
  ...
  if (isConnected && room) {
    return (
      <LiveKitRoom
        ...
        room={room}
      >
        <RoomContent isConnected={isConnected} roomId={resolvedParams.id} />
        <RoomAudioRenderer />
      </LiveKitRoom>
    );
  }
