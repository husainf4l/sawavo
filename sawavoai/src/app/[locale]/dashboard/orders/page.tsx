...
export default function OrdersPage() {
  ...
  const filters = [
    {
      key: "all",
      label: isRTL ? "جميع الطلبات" : "All Orders",
      count: orders.length,
    },
    {
      key: "delivered",
      label: isRTL ? "مُسلمة" : "Delivered",
            ...
            {filteredOrders.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
                ...
                <p className={`text-gray-500 ${isRTL ? "font-cairo" : ""}`}>
                  {isRTL
                    ? "لم نجد أي طلبات تطابق الفلتر المحدد"
                        ...
                        {order.status === "Delivered" && order.deliveryDate && (
                          <div className="flex items-center text-sm text-gray-600">
                            ...
                            <span className={isRTL ? "font-cairo" : ""}>
                              {isRTL ? "تم التسليم في " : "Delivered on "}
