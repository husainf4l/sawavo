...
export default function LocalSEO({ locale, businessInfo }: LocalSEOProps) {
  ...
  const generateLocalBusinessSchema = () => {
    ...
    return {
      ...
      sameAs: [
        "https://www.facebook.com/Sawavo",
        "https://www.instagram.com/Sawavo",
        "https://twitter.com/Sawavo",
      ],
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: isRTL
          ? "منتجات وخدمات العناية بالبشرة"
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              name: isRTL
                ...
                : "AI Skin Analysis",
              description: isRTL
                ? "تحليل متقدم لحالة البشرة باستخدام تقنيات الذكاء الاصطناعي"
                : "Advanced skin condition analysis using AI technology",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              "@type": "Product",
              name: isRTL
                ? "منتجات العناية بالبشرة الطبيعية"
                : "Natural Skincare Products",
              description: isRTL
                ? "منتجات عالية الجودة للعناية بالبشرة"
...
export const jordanKeywords = {
  en: {
    skincare:
      "Jordan skincare, Amman beauty products, Jordan cosmetics, Middle East skincare, Jordanian beauty, skincare Amman",
    products:
      "buy skincare Jordan, order beauty products Amman, Jordan online cosmetics, skincare delivery Jordan",
    analysis:
      "skin analysis Jordan, AI skincare Amman, dermatology consultation Jordan, skin doctor online Jordan",
    shop: "beauty shop Jordan, skincare store Amman, cosmetics retailer Jordan, online beauty shopping Jordan",
  },
  ar: {
    skincare:
      "العناية بالبشرة الأردن، منتجات التجميل عمان، مستحضرات التجميل الأردن، العناية بالبشرة الشرق الأوسط، التجميل الأردني، العناية بالبشرة عمان",
    products:
      "شراء منتجات العناية بالبشرة الأردن، طلب منتجات التجميل عمان، مستحضرات التجميل أونلاين الأردن، توصيل منتجات البشرة الأردن",
    analysis:
      "تحليل البشرة الأردن، العناية بالبشرة بالذكاء الاصطناعي عمان، استشارة جلدية الأردن، طبيب جلدية أونلاين الأردن",
