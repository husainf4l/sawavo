  ...
  en: [
    {
      ...
      items: [
        ...
        "Upload the photo to Sawavo's AI analysis tool",
    ...
    },
    {
      ...
      answer:
        "Our AI can accurately identify multiple skin concerns including acne, wrinkles, dark spots, pores, redness, and skin texture issues.",
      type: "paragraph" as const,
    },
    {
      question: "How accurate is AI skin analysis?",
      answer:
        "Sawavo's AI achieves 95% accuracy in skin analysis, trained on over 50,000 dermatologist-validated images.",
      type: "paragraph" as const,
    },
  ],
  ar: [
    {
      ...
      items: [
        ...
        "ارفع الصورة إلى أداة التحليل بالذكاء الاصطناعي من Sawavo",
    ...
    },
    {
      ...
      answer:
        "يمكن للذكاء الاصطناعي تحديد مشاكل البشرة المتعددة بدقة شاملة حب الشباب والتجاعيد والبقع الداكنة والمسام والاحمرار ومشاكل ملمس البشرة.",
      type: "paragraph" as const,
    },
  ],
};
